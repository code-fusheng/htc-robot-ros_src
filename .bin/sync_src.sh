...
# rsync -avz --progress ../drivers/Clash.tar.gz robot@192.168.1.154:/home/robot/htcbot_env
rsync -avz --progress ../drivers/curl.zip robot@192.168.1.154:/home/robot/htcbot_env
