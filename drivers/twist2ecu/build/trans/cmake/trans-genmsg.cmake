...
message(STATUS "trans: 1 messages, 0 services")

set(MSG_I_FLAGS "-Itrans:/home/mhy/twist2ecu/src/trans/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mhy/twist2ecu/src/trans/msg/ecu.msg" NAME_WE)
add_custom_target(_trans_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "trans" "/home/mhy/twist2ecu/src/trans/msg/ecu.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(trans
  "/home/mhy/twist2ecu/src/trans/msg/ecu.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/trans)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/trans\")")
  # install generated code
  install(
