...
private:
  ...
  ros::Publisher safety_waypoints_pub_, smartcar_safety_waypoints_pub_;
  ros::Subscriber costmap_sub_;
  ros::Subscriber current_pose_sub_;
  ros::Subscriber current_velocity_sub_, vehicle_status_sub_;
  ros::Subscriber base_waypoints_sub_, smartcar_base_waypoints_sub;
  ...
  void vehicleStatusCallback(const can_msgs::vehicle_status& msg);
  void baseWaypointsCallback(const autoware_msgs::Lane& msg);
  void smartcarBaseWaypointsCallback(const smartcar_msgs::Lane& msg);
