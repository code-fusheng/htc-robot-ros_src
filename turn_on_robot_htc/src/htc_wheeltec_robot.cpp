...
{
  ros::init(argc, argv, "htc_wheeltec_robot"); // ROS initializes and sets the node name // ROS初始化 并设置节点名称 
...
turn_on_robot::turn_on_robot():Sampling_Time(0),Power_voltage(0)
{
  ...
  private_nh.param<std::string>("usart_port_name",  usart_port_name,  "/dev/wheeltec_stm32"); //Fixed serial port number //固定串口号
